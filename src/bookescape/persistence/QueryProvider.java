...
public class QueryProvider implements IQueryProvider {
  ...
  @Override
  public List<List<String>> executeFilterQuery(String tableName, Set<String> selectedColumns, Map<String, String> conditions) {
    // create a template query with select clause
    ...
    if (!conditions.isEmpty()) {
      ...
      for (var entry : conditions.entrySet()) {
        whereConditions.add(entry.getKey() + " = '" + entry.getValue() + "'");
      }
